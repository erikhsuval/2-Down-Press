        ...
        NavigationStack {
            GeometryReader { geometry in
                ScrollView(showsIndicators: false) {
                    VStack(spacing: 0) {
                        ...
                        .frame(minHeight: geometry.size.height * 0.63)
            ...
            .onAppear {
                if isNewRound {
                    ...
                    groupManager.resetGroups() // Reset groups for new round
...
private struct ScorecardMainContentView: View {
    ...
    var body: some View {
        VStack(spacing: 0) {
            ...
            HStack {
                Text("Entering scores for:")
                    .font(.subheadline)
                    .foregroundColor(.gray)
                Text(currentPlayer.firstName)
                    .font(.headline)
...
struct ScoreDisplayView: View {
    ...
    private func scoreTextField() -> some View {
        ZStack(alignment: .trailing) {
            ...
            if scoreText.isEmpty && !isTextFieldFocused {
                Text("Tap to enter")
                    .font(.system(size: 12))
